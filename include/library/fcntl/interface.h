...
#define interceptr_set_wrapper_fcntl_open(interceptr, open) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(fcntl, open, interceptr)
...
#define interceptr_set_wrapper_fcntl___open_2(interceptr, __open_2) \
...
#define interceptr_set_wrapper_fcntl_open64(interceptr, open64) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(        \
        fcntl, open64, interceptr)
...
#define interceptr_set_wrapper_fcntl___open64_2(interceptr, __open64_2) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(                \
        fcntl, __open64_2, interceptr)
...
#define interceptr_set_wrapper_fcntl_openat(interceptr, openat) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(        \
        fcntl, openat, interceptr)
...
#define interceptr_set_wrapper_fcntl_openat_2(interceptr, openat_2) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(            \
        fcntl, openat_2, interceptr)
...
#define interceptr_set_wrapper_fcntl___openat_2(interceptr, __openat_2) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(                \
        fcntl, __openat_2, interceptr)
...
#define interceptr_set_wrapper_fcntl_openat64(interceptr, openat64) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(            \
        fcntl, openat64, interceptr)
...
#define interceptr_set_wrapper_fcntl_openat64_2(interceptr, openat64_2) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(                \
        fcntl, openat64_2, interceptr)
...
#define interceptr_set_wrapper_fcntl___openat64_2(interceptr, __openat64_2) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(                    \
        fcntl, __openat64_2, interceptr)
...
#define interceptr_set_wrapper_fcntl_creat(interceptr, creat) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(      \
        fcntl, creat, interceptr)
...
#define interceptr_set_wrapper_fcntl_creat64(interceptr, creat64) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(          \
        fcntl, creat64, interceptr)
...
#define interceptr_set_wrapper_fcntl_fopen64(interceptr, fopen64) \
    INTERCEPTR_GENERATE_WRAPPER_SETTER_MACRO_DEFINITION(          \
        fcntl, fopen64, interceptr)
